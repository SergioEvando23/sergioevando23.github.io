...
const portugues = {
  ...
  admin: {
    ...
    form: {
      ...
      fields: {
        ...
        demoUrl: 'URL da demonstracao',
        previewEnabled: 'Permitir execucao no Playground',
      ...
      helpers: {
        ...
        demoUrl: 'Use uma URL HTTPS publicada para habilitar a execucao.',
      },
      actions: {
      ...
      errors: {
        ...
        invalidDemoUrl: 'Informe uma URL HTTPS valida para executar o projeto.',
  ...
  studyGallery: {
    ...
    playground: {
      ...
      close: 'Fechar',
      error: 'Nao foi possivel carregar este projeto dentro do Playground.',
      dialogLabel: (title: string) => `Playground do projeto ${title}`,
    },
  ...
  studyAdmin: {
    ...
    fields: {
      ...
      githubUrl: 'URL do GitHub',
      demoUrl: 'URL da demonstracao',
      demoUrlHelp: 'Ao informar uma URL HTTPS, o Playground sera habilitado automaticamente.',
...
const ingles = {
  ...
  admin: {
    ...
    form: {
      ...
      fields: {
        ...
        demoUrl: 'Demo URL',
        previewEnabled: 'Allow running in the Playground',
      ...
      helpers: {
        ...
        demoUrl: 'Use a published HTTPS URL to enable running.',
      },
      actions: {
      ...
      errors: {
        ...
        invalidDemoUrl: 'Enter a valid HTTPS URL to run the project.',
  ...
  studyGallery: {
    ...
    playground: {
      ...
      close: 'Close',
      error: 'This project could not be loaded inside the Playground.',
      dialogLabel: (title: string) => `Project playground: ${title}`,
    },
  ...
  studyAdmin: {
    ...
    fields: {
      ...
      githubUrl: 'GitHub URL',
      demoUrl: 'Demo URL',
      demoUrlHelp: 'Providing an HTTPS URL automatically enables the Playground.',
