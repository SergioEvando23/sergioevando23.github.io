  ...
  return (
    <Container className="flex flex-col gap-8 py-12">
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
        <form
          className="grid gap-4 rounded-[var(--radius-xl)] border border-border bg-surface/80 p-5 shadow-[var(--shadow-card)] [&_.MuiFormHelperText-root]:font-semibold [&_.MuiFormHelperText-root]:text-error [&_.MuiInputBase-input]:text-text [&_.MuiInputBase-root]:bg-surface-secondary [&_.MuiInputBase-root]:text-text [&_.MuiInputBase-root.Mui-focused_.MuiOutlinedInput-notchedOutline]:border-primary [&_.MuiInputLabel-root]:text-text-muted [&_.MuiInputLabel-root.Mui-focused]:text-primary [&_.MuiOutlinedInput-notchedOutline]:border-border [&_.MuiSelect-icon]:text-text-muted"
          onSubmit={(event) => {
            event.preventDefault();
            void saveStudy();
          }}
